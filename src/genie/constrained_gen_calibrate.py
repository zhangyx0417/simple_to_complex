...
class BartConstrainedGenCalibrate(PreTrainedModel):
    def __init__(self, config, tokenizer):
        super(BartConstrainedGenCalibrate, self).__init__(config)
        self.config = config
    ...
    def forward(self, input_ids,
        ...
        # training
            ...
            temp_outputs = [lm_logits.view(-1, self.vocab_size), labels.view(-1)]
            return temp_outputs
